...
import java.util.*;;
 ...
 public class App {
   static ArrayList<pengeluaran_beasiswa>p_beasiswa = new ArrayList<pengeluaran_beasiswa>();
   static ArrayList<pengeluaran_bulanan>p_bulanan = new ArrayList<pengeluaran_bulanan>();
   ...
   static Scanner in = new Scanner(System.in);
    ...
    public static void tambah_pengeluaran_beasiswa(){
        ...
        pgl = in.nextInt();
        int sisa = p_beasiswa.get(p_beasiswa.size()-1).getUang_sekarang() - pgl;
        ...
        System.out.println("pengeluaran : " + p_beasiswa.get(daftar_pengeluaran).getPengeluaran());
    ...
    public static void edit_beasiswa(){
        ...
        int uang_sekarang = p_beasiswa.get(daftar-2).getUang_sekarang()-pgl;
        ...
        p_beasiswa.get(daftar-1).setUang_sekarang(uang_sekarang);
...
public static void tambah_pengeluaran_bulanan() throws Exception{
    ...
    System.out.println("pengeluaran : " + p_bulanan.get(daftar_pengeluaran).getPengeluaran());
...
public static void edit_bulanan(){
    ...
    int uang_sekarang = pemasukan_bulan.get(daftar-2).getUang_sekarang()-pgl;
    ...
    pemasukan_bulan.get(daftar-1).setUang_sekarang(uang_sekarang);
