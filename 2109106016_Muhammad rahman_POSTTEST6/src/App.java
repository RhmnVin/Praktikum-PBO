 ...
 public final class App {
   ...
   static Scanner in = new Scanner(System.in);
    ...
    public static void tambah_pengeluaran_beasiswa(){
        ...
        //         else{break;}
        //     }else {}}
        pengeluaran.tambah_pengeluaran("beasiswa", pgl);
    ...
    public static void hapus_pengeluaran_beasiswa(){
        ...
        System.out.println("menghapus daftar ke : ");
        daftar_hapus = in.nextInt();
        pengeluaran.hapus_pengeluaran("beasiswa", p_beasiswa.get(daftar_hapus-1).getPengeluaran());
...
public static void hapus_pengeluaran_bulanan(){
    ...
    System.out.println("menghapus daftar ke : ");
    daftar_hapus = in.nextInt();
    pengeluaran_bulanan.hapus_pengeluaran("bulanan", p_bulanan.get(daftar_hapus-1).getPengeluaran());
