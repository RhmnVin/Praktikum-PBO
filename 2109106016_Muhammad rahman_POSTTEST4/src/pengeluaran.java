...
public class pengeluaran {
    ...
    public void tambah_pengeluaran(String jenis, int jumlah){
        System.out.println("berhasil menambah data pengeluaran "+jenis+" dengan jumlah : Rp " + jumlah);
    }
    public void tambah_pengeluaran(int jumlah){
    ...
    public void hapus_pengeluaran(String jenis, int jumlah){
        System.out.println("berhasil megnhapus data pengeluaran "+jenis+" dengan jumlah jumlah pengeluaran : Rp " + jumlah);
    }
    public void hapus_pengeluaran(int jumlah){
        System.out.println("berhasil megnhapus data pengeluaran dengan jumlah jumlah pengeluaran : Rp " + jumlah);
    }
